...
var $author$project$Main$NewMole = function (a) {
	return {$: 'NewMole', a: a};
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Hit':
				var index = msg.a;
				return _Utils_eq(index, model.mole) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{score: model.score + 1}),
...
var $author$project$Main$Hit = function (a) {
	return {$: 'Hit', a: a};
};
...
var $author$project$Main$grid = function (model) {
	var cell = function (i) {
		var isMole = _Utils_eq(i, model.mole);
		var color = isMole ? 'gold' : '#444';
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_List_Nil,
				$author$project$Main$grid(model))
			]));
};
